...
from server.common.metrabs_pytorch import ptu, ptu3d
...
class MetrabsHeads(torch.nn.Module):
    ...
    def forward(self, inp):
        ...
        coords3d_rel_pred = heatmap_to_metric(coords3d, self.training)
        coords2d = ptu.soft_argmax(logits2d.float(), dim=(3, 2))
        coords2d_pred = heatmap_to_image(coords2d, self.training)
