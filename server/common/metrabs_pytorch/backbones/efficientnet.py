...
def _efficientnet_conf(
    ...
    if arch.startswith("efficientnet_b"):
        ...
        inverted_residual_setting = [
            ...
            bneck_conf(6, 5, 2, 112, 192, 4, bottomright_stride=True),
        ...
        inverted_residual_setting = [
            ...
            MBConvConfig(6, 3, 2, 160, 256, 15, bottomright_stride=True),
        ]
        last_channel = 1280
        ...
        inverted_residual_setting = [
            ...
            MBConvConfig(6, 3, 2, 176, 304, 18, bottomright_stride=True),
