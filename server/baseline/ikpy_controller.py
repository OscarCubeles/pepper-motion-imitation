...
def load_chains(script_dir):
    ...
    pepper_left_arm_chain = Chain.from_json_file(os.path.join(script_dir, "pepper_ik_resources", "pepper_left_arm.json"))
    pepper_right_arm_chain = Chain.from_json_file(os.path.join(script_dir, "pepper_ik_resources", "pepper_right_arm.json"))
    pepper_legs_chain = Chain.from_json_file(os.path.join(script_dir, "pepper_ik_resources", "pepper_legs.json"))
    pepper_head_chain = Chain.from_json_file(os.path.join(script_dir, "pepper_ik_resources", "pepper_head.json"))
...
def main():
    ...
    if mode == 'plot':
        ...
        interactive_ik_with_sliders(left_arm_chain, right_arm_chain, legs_chain, head_chain, arm="left")
