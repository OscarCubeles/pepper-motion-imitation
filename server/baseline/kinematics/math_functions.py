# np libarary is better for precision of numbers
# sympy is better for matrices
import numpy as np
...
# def position_interpolation(pos, prev_pos):

# def orientation_interpolation(orient, prev_orient):
