# -*- coding: utf-8 -*-
"""Legacy proposed-client entry point without Pepper audio output."""
...
if __package__:
    from . import pose_stream_runtime_proposed as pose_stream_runtime
else:
    import pose_stream_runtime_proposed as pose_stream_runtime
